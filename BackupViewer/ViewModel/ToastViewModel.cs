...
namespace BackupViewer.View
{
    class ToastViewModel : BaseVM
    {
        ...
        public ToastViewModel()
        {
            ...
            {
                cfg.LifetimeSupervisor = new TimeAndCountBasedLifetimeSupervisor(TimeSpan.FromSeconds(3), MaximumNotificationCount.FromCount(3));
